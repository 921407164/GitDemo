        ...
        <div id="main">            
            ...
            <form action="addcost.do" method="post" class="main_form">
                ...
                <div class="input_info fee_type">
                    <input type="radio" name="Type" id="monthly" onclick="feeTypeChange(1);" value="1" />
                    <label for="monthly">包月</label>
                    <input type="radio" name="Type" checked="checked" id="package" onclick="feeTypeChange(2);" value="2" />
                    <label for="package">套餐</label>
                    <input type="radio" name="Type" id="timeBased" onclick="feeTypeChange(3);" value="3"/>
